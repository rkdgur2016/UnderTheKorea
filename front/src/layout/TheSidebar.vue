    ...
    <div class="auth-section">
      <div v-if="isLoggedIn" class="logged-in-section">
        ...
        <div class="auth-buttons">
          <button @click="router.push('/mypage')" class="auth-btn mypage-btn">
            마이페이지
          </button>
        ...
        <div class="auth-content">
          <div v-if="activeTab === 'login'">
            <form @submit.prevent="handleLogin" class="auth-form">
              ...
              <p
                v-if="loginMessage"
                :class="{ success: isLoginSuccess, error: !isLoginSuccess }"
                class="auth-message"
              >
                {{ loginMessage }}
              </p>
          ...
          <div v-if="activeTab === 'signup'">
            <form @submit.prevent="handleSignup" class="auth-form">
              <div class="form-group">
                ...
                <p v-if="signupErrors.userId" class="error-message">
                  {{ signupErrors.userId }}
                </p>
                <p
                  v-if="userIdCheckMessage"
                  :class="{
                    success: isUserIdAvailable,
                    error: !isUserIdAvailable,
                  }"
                  class="check-message"
                >
                  {{ userIdCheckMessage }}
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  minlength="8"
                />
                <p v-if="signupErrors.password" class="error-message">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  required
                />
                <p v-if="signupErrors.confirmPassword" class="error-message">
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  maxlength="50"
                />
                <p v-if="signupErrors.username" class="error-message">
              ...
              <p
                v-if="signupMessage"
                :class="{ success: isSignupSuccess, error: !isSignupSuccess }"
                class="auth-message"
              >
                {{ signupMessage }}
              </p>
