        ...
        <div class="flex">
          ...
          <div class="w-96 p-6 bg-slate-50">
            <h3 class="text-lg font-semibold text-slate-800 mb-4">
              댓글 <span class="text-slate-500 font-normal">({{ comments?.length || 0 }})</span> </h3>
            ...
            <div class="mb-6">
              <div class="space-y-3">
                ...
                <p v-if="submitSuccess" class="text-green-500 text-sm mt-2">댓글이 성공적으로 작성되었습니다!</p>
              </div>
            </div>

            <div v-if="commentsLoading" class="text-center text-slate-500">댓글을 불러오는 중...</div>
            <div v-else-if="commentsError" class="text-center text-red-500">{{ commentsError }}</div>
            <div v-else-if="!comments || comments.length === 0" class="text-center text-slate-500">아직 댓글이 없습니다.</div>
                  ...
                  <div class="flex items-start space-x-2">
                    ...
                    <div class="flex-1 min-w-0">
                      <div class="flex items-center space-x-2 mb-1">
                        <span class="font-medium text-slate-800 text-sm">{{ comment.authorId }}</span>
                        <span class="text-xs text-slate-500">{{ formatDateTime(comment.createdAt) }}</span>
                      </div>
